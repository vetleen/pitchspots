...
def retrieve_pitchspot_view(request, pitchspot_id):
    ...
    pitchspot_dict = {'title': PitchspotToRetrieve.title, 
                      'owner': PitchspotToRetrieve.owner.username, 'admin': 'Not implemented', 'is_published': PitchspotToRetrieve.is_published}#, 'date_created': PitchspotToRetrieve.date_created}
